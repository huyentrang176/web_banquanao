                        ...
                        <div class="col-lg-6">
                            <div class="right-first-image">
                                <div class="thumb">
                                    <div class="inner-content">
                                        <h4>Dây lưng</h4>
                                        <span>Dây lưng đẹp cho nam giới</span>
                                    </div>
                                    <div class="hover-content">
                                        <div class="inner">
                                            <h4>Dây Lưng</h4>
                ...
                <div class="col-lg-12">
                    <div class="men-item-carousel">
                        <div class="owl-men-item owl-carousel">
                            <?php 
                            $listSphome_theodanhmuc = loadsphome($category['category_id']);
                            ...
                            <div class="item">
                                <div class="thumb">
                                    <div class="hover-content">
                                        <ul>
                                            <li><a href="index.php?act=chitietsanpham&product_id=<?php echo $sanpham['product_id']?>"><i class="fa fa-eye"></i></a></li>
                                            <!-- <li><a href="single-product.html"><i class="fa fa-star"></i></a></li> -->
                                            <!-- <li><a href="index.php?act=cart&product_id=<?php echo $sanpham['product_id']?>"><i class="fa fa-shopping-cart"></i></a></li> -->
                                        </ul>
                                    </div>
                                ...
                                <div class="down-content">
                                    ...
                                    <span>Giá: <?php echo $sanpham['price']?> VNĐ</span>
                                    <ul class="stars">
                                        <li><i class="fa fa-eye" style="font-size:20px"></i></li>
                                        <li><?php echo $sanpham['view']?> Lượt xem</li>
                                    </ul>
                                </div>
                            </div>
                            <?php endforeach;?>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-heading">
                    ...
                    <span>Chi tiết đến từng chi tiết là điều khiến shop chúng tôi khác biệt so với các chủ đề
                        khác.</span>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="section-heading">
                    ...
                    <span>Chi tiết đến từng chi tiết là điều khiến khác biệt so với các chủ đề
                        khác.</span>
                </div>
            ...
            <div class="col-lg-4">
                <div class="row">
                    <div class="col-6">
                        <ul>
                            <li>Vị trí cửa hàng:<br><span>Tầng 4 - Tòa F - Phòng F404</span></li>
