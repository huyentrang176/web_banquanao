            ...
            <div class="container pt-5 mt-5">
                <form action="index.php?act=addproduct" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                        ...
                        <span style="color:red;"><?php echo isset($error_tensp) ? $error_tensp : '' ?></span>
                    </div>
                    <div class="mb-3">
                        ...
                        <span style="color:red;"><?php echo isset($error_img) ? $error_img : '' ?></span>
                    </div>
                    <div class="mb-3">
                        ...
                        <span style="color:red;"><?php echo isset($error_giasp) ? $error_giasp : '' ?></span>
                    </div>
                    <div class="mb-3">
                        <label for="exampleFormControlTextarea1" class="form-label">Mô tả</label>
                        <textarea class="form-control" name="mota" id="exampleFormControlTextarea1" rows="3"></textarea>
                        <span style="color:red;"><?php echo isset($error_mota) ? $error_mota : '' ?></span>
                    </div>
                    <div class="mb-3" >
                        ...
                        <span style="color:red;"><?php echo isset($error_iddm) ? $error_iddm : '' ?></span>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="footer_iner text-center">
                        <p>2024 - FPOLY HN<a href="#"> <i class="ti-het"></i></a></p>
                    </div>
                </div>
            </div>
        </div>
